...
export default async function RestaurantPage({ params }: PageProps) {
  ...
  const safetyScore = calculateSafetyScore(restaurant);
       ...
       <section className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-12">
         <div className="max-w-4xl mx-auto px-4">
           <div className="flex justify-between items-start">
             ...
             <div className="flex items-center bg-white text-blue-700 px-6 py-3 rounded-xl shadow-lg">
               <span className="text-3xl font-bold">{safetyScore}/4</span>
               <span className="ml-3 text-lg">Safety Score</span>
             </div>
           </div>
         </div>
       </section>
       ...
       <section className="max-w-4xl mx-auto px-4 py-8">
         <div className="grid md:grid-cols-3 gap-6">
           ...
           <div className="md:col-span-2 space-y-6">
             ...
             <div className="bg-white rounded-2xl p-8 shadow-md">
               ...
               <ul className="space-y-4">
                 {restaurant.gfHighlights.map((highlight, index) => (
                   <li key={index} className="flex items-start bg-blue-50 p-5 rounded-xl">
                     <svg className="w-7 h-7 text-blue-600 mr-4 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
             ...
             <div className="bg-white rounded-2xl p-8 shadow-md">
               <h2 className="text-2xl font-bold mb-4 flex items-center">
                 <svg className="w-7 h-7 mr-2 text-amber-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
           ...
           <div className="space-y-6">
             ...
             <div className="bg-white rounded-2xl p-6 shadow-md">
               ...
               <a
                ...
                className="inline-block bg-blue-600 text-white px-4 py-3 rounded-lg font-medium hover:bg-blue-700 transition-colors"
               >
                Get Directions &rarr;
               </a>
             </div>
               ...
               <div className="space-y-3">
                 ...
                 {restaurant.dedicatedFryer && (
                   <div className="flex items-center bg-slate-50 p-4 rounded-lg">
                     <svg className="w-7 h-7 text-slate-600 mr-3" fill="currentColor" viewBox="0 0 20 20">
                       <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                     </svg>
           ...
           {restaurants
             ...
             .map((r) => (
               <Link
                ...
                className="group block bg-gray-50 rounded-xl p-6 hover:shadow-lg transition-all border border-gray-100 hover:border-blue-300"
               >
                 <div className="flex justify-between items-start mb-3">
                   ...
                   <div className="flex items-center bg-blue-100 text-blue-800 px-3 py-1 rounded-full">
                     <span className="text-lg font-bold">{calculateSafetyScore(r)}/4</span>
